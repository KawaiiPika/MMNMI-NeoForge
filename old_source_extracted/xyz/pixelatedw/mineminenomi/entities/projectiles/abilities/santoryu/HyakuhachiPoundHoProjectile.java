...
public class HyakuhachiPoundHoProjectile extends NuProjectileEntity {
   public HyakuhachiPoundHoProjectile(EntityType type, Level world) {
      super(type, world);
   }

   public HyakuhachiPoundHoProjectile(Level world, LivingEntity player, Ability ability) {
      super((EntityType)ModProjectiles.HYAKUHACHI_POUND_HO.get(), world, player, ability);
