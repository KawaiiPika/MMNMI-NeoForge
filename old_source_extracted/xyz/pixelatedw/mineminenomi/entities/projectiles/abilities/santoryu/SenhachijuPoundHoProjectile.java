...
public class SenhachijuPoundHoProjectile extends NuProjectileEntity {
   public SenhachijuPoundHoProjectile(EntityType type, Level world) {
      super(type, world);
   }

   public SenhachijuPoundHoProjectile(Level world, LivingEntity player, Ability ability) {
      super((EntityType)ModProjectiles.SENHACHIJU_POUND_HO.get(), world, player, ability);
