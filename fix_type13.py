...
content = content.replace("xyz.pixelatedw.mineminenomi.init.ModRecipes.SMITHING_DIAL.value()", "new SmithingDialRecipe.Serializer()")
...
content2 = content2.replace("xyz.pixelatedw.mineminenomi.init.ModRecipes.SMITHING_ENCHANTMENT.value()", "new SmithingEnchantmentRecipe.Serializer()")
...
content3 = content3.replace("xyz.pixelatedw.mineminenomi.init.ModRecipes.MULTI_CHANNEL_ARMOR_DYE.value()", "new net.minecraft.world.item.crafting.SimpleCraftingRecipeSerializer<>(MultiChannelDyeRecipe::new)")
