...
public class GrabbedEffect extends BaseEffect implements IBindBodyEffect, IBindHandsEffect {
   public GrabbedEffect() {
      ...
      this.m_19472_(Attributes.f_22283_, "e6435603-f78f-42a2-9b21-ff8b899f2a59", (double)-1.0F, Operation.MULTIPLY_TOTAL);
      ...
      this.m_19472_(Attributes.f_22278_, "f8b2474d-4cdb-42b0-a868-327443a2a505", (double)1.0F, Operation.MULTIPLY_TOTAL);
   }
