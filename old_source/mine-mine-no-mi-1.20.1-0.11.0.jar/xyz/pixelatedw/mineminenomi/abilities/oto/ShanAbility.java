...
public class ShanAbility extends Ability {
   ...
   public static final RegistryObject<AbilityCore<ShanAbility>> INSTANCE = ModRegistry.registerAbility("shan", "Shan", (id, name) -> {
      Component[] desc = AbilityHelper.registerDescriptionText("mineminenomi", id, ImmutablePair.of("The user turns their head into a cymbal, by pushing their own head they create a sound shockwave powerful enough to internally cut any entity hearing it", (Object)null));
      return (new AbilityCore.Builder(id, name, AbilityCategory.DEVIL_FRUITS, ShanAbility::new)).addDescriptionLine(desc).addAdvancedDescriptionLine(AbilityDescriptionLine.NEW_LINE, CooldownComponent.getTooltip(60.0F), DealDamageComponent.getTooltip(25.0F), RangeComponent.getTooltip(24.0F, RangeComponent.RangeType.CONE)).setSourceHakiNature(SourceHakiNature.SPECIAL).setSourceType(SourceType.INTERNAL, SourceType.SLASH, SourceType.INDIRECT).setSourceElement(SourceElement.SHOCKWAVE).build("mineminenomi");
   });
   ...
   private void onUseEvent(LivingEntity entity, IAbility ability) {
      entity.m_9236_().m_5594_((Player)null, entity.m_20183_(), (SoundEvent)ModSounds.SHAN.get(), SoundSource.PLAYERS, 3.0F, 0.2F + entity.m_217043_().m_188501_());
