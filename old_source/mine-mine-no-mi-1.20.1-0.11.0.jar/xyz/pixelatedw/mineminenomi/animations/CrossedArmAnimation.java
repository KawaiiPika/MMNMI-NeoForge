...
public class CrossedArmAnimation extends Animation<LivingEntity, HumanoidModel<LivingEntity>> {
   private HumanoidArm side;

   public CrossedArmAnimation(AnimationId<CrossedArmAnimation> animId, HumanoidArm side) {
      super(animId);
   ...
   public void angles(LivingEntity player, HumanoidModel<LivingEntity> model, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      arm.f_104203_ = -1.2415929F;
      arm.f_104204_ = 1.2F * (float)sideMod;
      arm.f_104205_ = 0.8F * (float)sideMod;
   }
}
