...
public class UnconsciousAnimation extends Animation<LivingEntity, EntityModel<LivingEntity>> {
   ...
   public void start(LivingEntity entity, int animDuration) {
      ...
      if (entity instanceof Player || entity instanceof Mob) {
         boolean useSpecialAnimation = entity.m_217043_().m_188503_(10) > 0;
   ...
   private void angles(LivingEntity entity, EntityModel<LivingEntity> entityModel, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      RendererHelper.resetModelToDefaultPivots(entityModel);
      if (entity.m_20159_()) {
         ...
         if (entityModel instanceof HumanoidModel) {
            ...
            bipedModel.f_102812_.f_104203_ = 0.0F;
            bipedModel.f_102812_.f_104205_ = -0.05F;
            bipedModel.f_102811_.f_104203_ = 0.0F;
            bipedModel.f_102811_.f_104205_ = 0.05F;
   ...
   private void postAngles(LivingEntity entity, EntityModel<LivingEntity> entityModel, PoseStack matrixStack, MultiBufferSource buffer, int packedLight, float partialTicks, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      if (entity.m_20159_()) {
         ...
         matrixStack.m_85837_((double)0.0F, (double)-0.5F, -1.4);
      }
   }
}
