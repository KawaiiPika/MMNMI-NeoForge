...
public class ChiyupopoParticleEffect extends ParticleEffect<ParticleEffect.NoDetails> {
   public void spawn(Entity entity, Level world, double posX, double posY, double posZ, ParticleEffect.NoDetails details) {
      ...
      while(t < (double)1.0F) {
         ...
         for(double theta = (double)0.0F; theta <= 12.566370614359172; theta += (Math.PI / 10D)) {
            double x = t * Math.cos(theta);
            double y = 0.2 + (double)rand.m_188503_(1);
