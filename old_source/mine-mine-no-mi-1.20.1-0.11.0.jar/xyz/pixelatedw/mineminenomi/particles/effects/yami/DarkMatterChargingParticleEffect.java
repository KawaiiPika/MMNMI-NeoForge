...
public class DarkMatterChargingParticleEffect extends ParticleEffect<ParticleEffect.NoDetails> {
   public void spawn(Entity entity, Level world, double posX, double posY, double posZ, ParticleEffect.NoDetails details) {
      ...
      while(t < (double)1.0F) {
         ...
         for(double theta = (double)0.0F; theta <= 12.566370614359172; theta += 0.19634954084936207) {
            ...
            world.m_6493_(part, true, posX + x * (double)1.25F + WyHelper.randomDouble(), posY + y, posZ + z * (double)1.25F + WyHelper.randomDouble(), (double)0.0F, (double)0.0F, (double)0.0F);
            part.setLife(14);
            part.setAnimationSpeed(2);
            part.setRotation(0.0F, 0.0F, 1.0F);
            part.setRotationSpeed(t % (double)2.0F == (double)0.0F ? 0.07F : -0.07F);
            part.setSize(1.3F);
            part.setMotion(motionX, motionY + 0.15, motionZ);
            world.m_6493_(part, true, posX + x * (double)2.0F + WyHelper.randomDouble(), posY + y, posZ + z * (double)2.0F + WyHelper.randomDouble(), (double)0.0F, (double)0.0F, (double)0.0F);
         }
      }
