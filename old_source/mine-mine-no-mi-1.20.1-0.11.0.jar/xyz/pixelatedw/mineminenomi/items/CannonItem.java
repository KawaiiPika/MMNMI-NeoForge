...
public class CannonItem extends Item {
   ...
   public InteractionResultHolder<ItemStack> m_7203_(Level level, Player player, InteractionHand hand) {
      ...
      if (hitResult.m_6662_() == Type.MISS) {
         ...
         cannon.m_6034_(hitResult.m_82450_().f_82479_, hitResult.m_82450_().f_82480_, hitResult.m_82450_().f_82481_);
         cannon.m_146922_(player.m_146908_());
         if (!level.f_46443_) {
            level.m_7967_(cannon);
