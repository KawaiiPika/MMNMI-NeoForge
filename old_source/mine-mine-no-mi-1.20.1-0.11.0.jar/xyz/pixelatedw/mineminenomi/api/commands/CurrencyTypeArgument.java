...
public class CurrencyTypeArgument<T extends Enum<T>> implements ArgumentType<T> {
   private final Class<T> enumClass;

   public static CurrencyTypeArgument<Currency> currencyType() {
      return new CurrencyTypeArgument<Currency>(Currency.class);
   }

   public CurrencyTypeArgument(Class<T> enumClass) {
   ...
   public static class Info<T extends Enum<T>> implements ArgumentTypeInfo<CurrencyTypeArgument<T>, Info<T>.Template> {
      ...
      public Info<T>.Template unpack(CurrencyTypeArgument<T> argument) {
         return new Template(argument.enumClass);
      }

      public class Template implements ArgumentTypeInfo.Template<CurrencyTypeArgument<T>> {
         ...
         public CurrencyTypeArgument<T> instantiate(CommandBuildContext p_223435_) {
            return new CurrencyTypeArgument<T>(this.enumClass);
         }

         public ArgumentTypeInfo<CurrencyTypeArgument<T>, ?> m_213709_() {
            return Info.this;
         }
      }
   }
