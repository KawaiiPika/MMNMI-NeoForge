...
public class LeaveCrewTrigger extends SimpleCriterionTrigger<Instance> {
   private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("mineminenomi", "leave_crew");
   ...
   public static class Instance extends AbstractCriterionTriggerInstance {
      public Instance(ContextAwarePredicate entityPredicate) {
         super(LeaveCrewTrigger.ID, entityPredicate);
      }
