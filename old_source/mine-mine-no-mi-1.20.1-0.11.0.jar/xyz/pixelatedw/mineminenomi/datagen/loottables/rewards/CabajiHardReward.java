...
public class CabajiHardReward {
   ...
   static {
      ITEMS = LootPool.m_79043_().name("mineminenomi:items").m_165133_(ConstantValue.m_165692_(1.0F)).m_79076_(EmptyLootItem.m_79533_().m_79707_(93).m_79711_(-5)).m_79076_(LootItem.m_79579_((ItemLike)ModItems.UNICYCLE.get()).m_79707_(3)).m_79076_(LootItem.m_79579_((ItemLike)ModArmors.CABAJI_SCARF.get()).m_79707_(5));
   }
}
