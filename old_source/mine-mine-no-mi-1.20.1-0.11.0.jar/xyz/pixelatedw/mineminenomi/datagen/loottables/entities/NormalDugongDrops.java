...
public class NormalDugongDrops {
   ...
   static {
      ...
      ITEMS2 = LootPool.m_79043_().name("mineminenomi:items2").m_165133_(ConstantValue.m_165692_(1.0F)).m_79080_(LootItemKilledByPlayerCondition.m_81901_()).m_79080_(LootItemRandomChanceWithLootingCondition.m_81963_(0.4F, 0.04F)).m_79076_(LootItem.m_79579_(Items.f_42355_).m_79707_(100).m_79078_(SetItemCountFunction.m_165412_(UniformGenerator.m_165780_(1.0F, 2.0F))));
   }
}
