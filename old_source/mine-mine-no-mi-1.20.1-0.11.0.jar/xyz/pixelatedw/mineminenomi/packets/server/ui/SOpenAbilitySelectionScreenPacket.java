...
public class SOpenAbilitySelectionScreenPacket {
   ...
   public static SOpenAbilitySelectionScreenPacket decode(FriendlyByteBuf buffer) {
   ...
   public static void handle(SOpenAbilitySelectionScreenPacket message, Supplier<NetworkEvent.Context> ctx) {
      if (((NetworkEvent.Context)ctx.get()).getDirection() == NetworkDirection.PLAY_TO_CLIENT) {
         ((NetworkEvent.Context)ctx.get()).enqueueWork(() -> SOpenAbilitySelectionScreenPacket.ClientHandler.handle(message));
      }
   ...
   public static class ClientHandler {
      ...
      public static void handle(SOpenAbilitySelectionScreenPacket message) {
         ...
         if (player != null) {
            Minecraft.m_91087_().m_91152_(new AbilitiesListScreen());
         }
      }
   }
}
