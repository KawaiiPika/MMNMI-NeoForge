...
public class OPBossEntity extends PathfinderMob implements IChallengeBoss, IEntityAdditionalSpawnData {
   ...
   private OPBossEntity(EntityType<? extends OPBossEntity> type, Level world, @Nullable InProgressChallenge inProgressChallenge) {
      super(type, world);
      this.bossInfo = new ServerOPBossEvent(this.m_5446_());
   ...
   public void m_8119_() {
      ...
      if (!this.m_9236_().f_46443_) {
         ...
         if (this.m_9236_().m_46467_() % 20L == 0L) {
            ...
            boolean isOutsideBounds = !NuWorld.isWithinChallengeArenaBounds(this.m_9236_(), this.m_20183_());
            if (!isSuffocating) {
               this.lastSafePosition = this.m_20183_();
