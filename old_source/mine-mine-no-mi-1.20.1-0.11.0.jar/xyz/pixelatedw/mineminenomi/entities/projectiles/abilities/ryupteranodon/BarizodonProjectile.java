...
public class BarizodonProjectile extends NuProjectileEntity {
   public BarizodonProjectile(EntityType<? extends BarizodonProjectile> type, Level world) {
      super(type, world);
   }

   public BarizodonProjectile(Level world, LivingEntity player, IAbility parent) {
      super((EntityType)ModProjectiles.BARIZODON.get(), world, player, parent);
