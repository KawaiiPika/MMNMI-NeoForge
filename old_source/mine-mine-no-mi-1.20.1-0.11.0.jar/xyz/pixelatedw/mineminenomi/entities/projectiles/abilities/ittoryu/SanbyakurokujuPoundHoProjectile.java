...
public class SanbyakurokujuPoundHoProjectile extends NuProjectileEntity {
   public SanbyakurokujuPoundHoProjectile(EntityType<? extends SanbyakurokujuPoundHoProjectile> type, Level world) {
      super(type, world);
   }

   public SanbyakurokujuPoundHoProjectile(Level world, LivingEntity player, Ability ability) {
      super((EntityType)ModProjectiles.SANBYAKUROKUJU_POUND_HO.get(), world, player, ability);
