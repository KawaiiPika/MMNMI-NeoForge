...
public class UchimizuProjectile extends NuProjectileEntity {
   public UchimizuProjectile(EntityType<? extends UchimizuProjectile> type, Level world) {
      super(type, world);
   }

   public UchimizuProjectile(Level world, LivingEntity player, IAbility ability) {
      super((EntityType)ModProjectiles.UCHIMIZU.get(), world, player, ability);
      this.setDamage(5.0F);
      this.setMaxLife(30);
   ...
   private void blockHitEvent(BlockHitResult hit) {
      ExplosionComponent.createExplosion((IAbility)((IAbility)this.getParent().orElse((Object)null)), (comp) -> {
         AbilityExplosion explosion = comp.createExplosion(this, this.getOwner(), (double)hit.m_82425_().m_123341_(), (double)hit.m_82425_().m_123342_(), (double)hit.m_82425_().m_123343_(), 1.0F);
