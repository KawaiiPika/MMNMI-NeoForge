...
public class GomuGomuNoJetBazookaProjectile extends NuHorizontalLightningEntity {
   private static final double KNOCKBACK = (double)8.0F;
   private Vec3 lookVec;

   public GomuGomuNoJetBazookaProjectile(EntityType<? extends GomuGomuNoJetBazookaProjectile> type, Level world) {
      super(type, world);
      this.lookVec = Vec3.f_82478_;
   }

   public GomuGomuNoJetBazookaProjectile(Level world, LivingEntity entity, Ability ability) {
      super((EntityType)ModProjectiles.GOMU_GOMU_NO_JET_BAZOOKA.get(), entity, 20.0F, 12.0F, ability);
      this.lookVec = Vec3.f_82478_;
      this.setRetracting();
      this.setSize(0.025F);
      this.setOneTimeHit();
