...
public class WhiteBlowProjectile extends NuProjectileEntity {
   public WhiteBlowProjectile(EntityType<? extends WhiteBlowProjectile> type, Level world) {
      super(type, world);
   }

   public WhiteBlowProjectile(Level world, LivingEntity player, IAbility ability) {
   ...
   private void onEntityHit(EntityHitResult result) {
      ...
      if (var3 instanceof LivingEntity target) {
         target.m_7292_(new MobEffectInstance((MobEffect)ModEffects.SMOKE.get(), 500, 0));
      }
