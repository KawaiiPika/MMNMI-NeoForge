...
public class RadicalBeamProjectile extends NuHorizontalLightningEntity {
   public RadicalBeamProjectile(EntityType<? extends RadicalBeamProjectile> type, Level world) {
      super(type, world);
   }

   public RadicalBeamProjectile(Level world, LivingEntity thrower, IAbility ability) {
      super((EntityType)ModProjectiles.RADICAL_BEAM.get(), thrower, 128.0F, 12.0F, ability);
      this.setFadeTime(20);
      this.setDamage(50.0F);
      this.setSize(0.28F);
      this.setColor(ElThorAbility.YELLOW_THUNDER, 100);
      this.setAngle(100);
      this.setTargetTimeToReset(100);
   ...
   private void blockHitEvent(BlockHitResult result) {
      ExplosionComponent.createExplosion((IAbility)((IAbility)this.getParent().orElse((Object)null)), (comp) -> {
         AbilityExplosion explosion = comp.createExplosion(this, this.getOwner(), (double)result.m_82425_().m_123341_(), (double)result.m_82425_().m_123342_(), (double)result.m_82425_().m_123343_(), 4.0F);
