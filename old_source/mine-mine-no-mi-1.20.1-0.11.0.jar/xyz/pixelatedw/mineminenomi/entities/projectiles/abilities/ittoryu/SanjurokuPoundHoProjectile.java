...
public class SanjurokuPoundHoProjectile extends NuProjectileEntity {
   public SanjurokuPoundHoProjectile(EntityType type, Level world) {
      super(type, world);
   }

   public SanjurokuPoundHoProjectile(Level world, LivingEntity player, Ability ability) {
      super((EntityType)ModProjectiles.SANJUROKU_POUND_HO.get(), world, player, ability);
