...
content = content.replace("new SmithingDialRecipe.Serializer()", "xyz.pixelatedw.mineminenomi.init.ModRecipes.SMITHING_DIAL.get()")
...
content2 = content2.replace("new SmithingEnchantmentRecipe.Serializer()", "xyz.pixelatedw.mineminenomi.init.ModRecipes.SMITHING_ENCHANTMENT.get()")
...
content3 = content3.replace("new net.minecraft.world.item.crafting.SimpleCraftingRecipeSerializer<>(MultiChannelDyeRecipe::new)", "xyz.pixelatedw.mineminenomi.init.ModRecipes.MULTI_CHANNEL_ARMOR_DYE.get()")
