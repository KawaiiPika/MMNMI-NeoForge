...
content = content.replace("xyz.pixelatedw.mineminenomi.init.ModRecipes.SMITHING_DIAL.getDelegate().get()", "xyz.pixelatedw.mineminenomi.init.ModRecipes.SMITHING_DIAL.value()")
...
content2 = content2.replace("xyz.pixelatedw.mineminenomi.init.ModRecipes.SMITHING_ENCHANTMENT.getDelegate().get()", "xyz.pixelatedw.mineminenomi.init.ModRecipes.SMITHING_ENCHANTMENT.value()")
...
content3 = content3.replace("xyz.pixelatedw.mineminenomi.init.ModRecipes.MULTI_CHANNEL_ARMOR_DYE.getDelegate().get()", "xyz.pixelatedw.mineminenomi.init.ModRecipes.MULTI_CHANNEL_ARMOR_DYE.value()")
