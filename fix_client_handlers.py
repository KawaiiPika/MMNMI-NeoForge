with open('src/main/java/xyz/pixelatedw/mineminenomi/client/networking/ClientPacketHandlers.java', 'w') as f:
    f.write('''package xyz.pixelatedw.mineminenomi.client.networking;
