...
public class ModEntities {
    ...
    public static final java.util.function.Supplier<net.minecraft.world.entity.EntityType<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.MokoProjectile>> MOKO_PROJECTILE = ModRegistry.ENTITY_TYPES.register("moko_projectile", () -> net.minecraft.world.entity.EntityType.Builder.<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.MokoProjectile>of(xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.MokoProjectile::new, net.minecraft.world.entity.MobCategory.MISC).sized(2.0F, 2.0F).clientTrackingRange(10).updateInterval(20).build("moko_projectile"));
    public static final java.util.function.Supplier<net.minecraft.world.entity.EntityType<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.SagariNoRyuseiProjectile>> SAGARI_NO_RYUSEI_PROJECTILE = ModRegistry.ENTITY_TYPES.register("sagari_no_ryusei_projectile", () -> net.minecraft.world.entity.EntityType.Builder.<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.SagariNoRyuseiProjectile>of(xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.SagariNoRyuseiProjectile::new, net.minecraft.world.entity.MobCategory.MISC).sized(24.0F, 24.0F).clientTrackingRange(10).updateInterval(20).build("sagari_no_ryusei_projectile"));

    public static final Supplier<EntityType<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.MokoProjectile>> MOKO_PROJECTILE = ModRegistry.ENTITY_TYPES.register("moko_projectile", () -> EntityType.Builder.<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.MokoProjectile>of(xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.MokoProjectile::new, MobCategory.MISC).sized(2.0F, 2.0F).clientTrackingRange(10).updateInterval(20).build("moko_projectile"));
    public static final Supplier<EntityType<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.SagariNoRyuseiProjectile>> SAGARI_NO_RYUSEI_PROJECTILE = ModRegistry.ENTITY_TYPES.register("sagari_no_ryusei_projectile", () -> EntityType.Builder.<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.SagariNoRyuseiProjectile>of(xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.SagariNoRyuseiProjectile::new, MobCategory.MISC).sized(24.0F, 24.0F).clientTrackingRange(10).updateInterval(20).build("sagari_no_ryusei_projectile"));
