...
public class ModEntities {
    ...
    public static final Supplier<EntityType<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.MokoProjectile>> MOKO_PROJECTILE = ModRegistry.ENTITY_TYPES.register("moko_projectile",
            () -> EntityType.Builder.<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.MokoProjectile>of(xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.MokoProjectile::new, MobCategory.MISC).sized(1.5F, 1.5F).clientTrackingRange(10).updateInterval(20).build("moko_projectile"));
    public static final Supplier<EntityType<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.SagariNoRyuseiProjectile>> SAGARI_NO_RYUSEI_PROJECTILE = ModRegistry.ENTITY_TYPES.register("sagari_no_ryusei_projectile",
            () -> EntityType.Builder.<xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.SagariNoRyuseiProjectile>of(xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.zushi.SagariNoRyuseiProjectile::new, MobCategory.MISC).sized(5.0F, 5.0F).clientTrackingRange(10).updateInterval(20).build("sagari_no_ryusei_projectile"));
