...
public class ModEffects {
    ...
    public static final net.neoforged.neoforge.registries.DeferredHolder<MobEffect, MobEffect> HANDCUFFED = EFFECTS.register("handcuffed", () -> new HandcuffedEffect(xyz.pixelatedw.mineminenomi.api.enums.HandcuffType.NORMAL, net.minecraft.world.entity.ai.attributes.Attributes.MOVEMENT_SPEED, net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_SPEED));
    public static final net.neoforged.neoforge.registries.DeferredHolder<MobEffect, MobEffect> HANDCUFFED_KAIROSEKI = EFFECTS.register("handcuffed_kairoseki", () -> new HandcuffedEffect(xyz.pixelatedw.mineminenomi.api.enums.HandcuffType.KAIROSEKI, net.minecraft.world.entity.ai.attributes.Attributes.MOVEMENT_SPEED, net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_SPEED));
    public static final net.neoforged.neoforge.registries.DeferredHolder<MobEffect, MobEffect> HANDCUFFED_EXPLOSIVE = EFFECTS.register("handcuffed_explosive", () -> new HandcuffedEffect(xyz.pixelatedw.mineminenomi.api.enums.HandcuffType.EXPLOSIVE, net.minecraft.world.entity.ai.attributes.Attributes.MOVEMENT_SPEED, net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_SPEED));
