...
public class StringPillarEntity extends ThrowableProjectile {
    @Override
    protected void defineSynchedData(net.minecraft.network.syncher.SynchedEntityData.Builder builder) {
    }

    public StringPillarEntity(EntityType<? extends ThrowableProjectile> type, Level level) {
        super(type, level);
    }

    public StringPillarEntity(Level level, LivingEntity thrower) {
        super(ModEntities.STRING_PILLAR.get(), thrower, level);
    }
