...
public class BarizodonAbility extends Ability {
    ...
    protected void startUsing(LivingEntity entity) {
        if (!entity.level().isClientSide) {
            ...
            xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.ryupteranodon.BarizodonProjectile proj = new xyz.pixelatedw.mineminenomi.entities.projectiles.abilities.ryupteranodon.BarizodonProjectile(entity.level(), entity);
            proj.shootFromRotation(entity, entity.getXRot(), entity.getYRot(), 0.0F, 3.0F, 10.0F);
    ...
    public Component getDisplayName() {
        return Component.translatable("ability.mineminenomi.barizodon");
    }
}
