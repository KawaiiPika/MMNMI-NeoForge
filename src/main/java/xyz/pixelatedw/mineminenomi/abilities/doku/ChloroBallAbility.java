...
import xyz.pixelatedw.mineminenomi.entities.projectiles.ChloroBallEntity;
...
public class ChloroBallAbility extends Ability {
    ...
    protected void startUsing(LivingEntity entity) {
        if (!entity.level().isClientSide) {
            ...
            ChloroBallEntity projectile = new ChloroBallEntity(entity.level(), entity);
    ...
    public Component getDisplayName() {
        return Component.translatable("ability.mineminenomi.chloro_ball");
    }
}
