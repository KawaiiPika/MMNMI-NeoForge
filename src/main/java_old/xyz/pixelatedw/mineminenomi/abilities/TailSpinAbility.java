...
public class TailSpinAbility extends Ability {
   ...
   public static final RegistryObject<AbilityCore<TailSpinAbility>> INSTANCE = ModRegistry.registerAbility("tail_spin", "Tail Spin", (id, name) -> {
