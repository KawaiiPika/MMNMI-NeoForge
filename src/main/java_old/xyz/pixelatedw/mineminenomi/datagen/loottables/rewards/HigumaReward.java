...
public class HigumaReward {
   ...
   static {
      HARD_MODE = LootPool.m_79043_().name("mineminenomi:hard_mode").m_165133_(ConstantValue.m_165692_(1.0F)).m_79080_(FirstCompletionRewardCondition.builder()).m_79076_(LootItem.m_79579_(Items.f_41852_).m_79078_(UnlockChallengesFunction.builder((ChallengeCore)ModChallenges.HIGUMA_HARD.get())));
   }
}
