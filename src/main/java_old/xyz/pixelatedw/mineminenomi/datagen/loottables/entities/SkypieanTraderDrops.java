...
public class SkypieanTraderDrops {
   ...
   static {
      ITEMS = LootPool.m_79043_().name("mineminenomi:items").m_165133_(UniformGenerator.m_165780_(0.0F, 1.0F)).m_79076_(LootItem.m_79579_((ItemLike)ModItems.EXTOL_POUCH.get()).m_79707_(100).m_79078_(SetItemCountFunction.m_165412_(ConstantValue.m_165692_(1.0F))).m_79078_(SetExtolInPouchFunction.builder(UniformGenerator.m_165780_(1000000.0F, 3000000.0F))));
   }
}
