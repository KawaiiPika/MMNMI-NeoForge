...
public class Mr1Reward {
   ...
   static {
      HARD_MODE = LootPool.m_79043_().name("mineminenomi:hard_mode").m_165133_(ConstantValue.m_165692_(1.0F)).m_79080_(FirstCompletionRewardCondition.builder()).m_79076_(LootItem.m_79579_(Items.f_41852_).m_79078_(UnlockChallengesFunction.builder((ChallengeCore)ModChallenges.MR_1_HARD.get())));
      ITEMS = LootPool.m_79043_().name("mineminenomi:items").m_165133_(ConstantValue.m_165692_(1.0F)).m_79076_(EmptyLootItem.m_79533_().m_79707_(94).m_79711_(-5)).m_79076_(LootItem.m_79579_((ItemLike)ModArmors.MR1_CHEST.get()).m_79707_(2)).m_79076_(LootItem.m_79579_((ItemLike)ModArmors.MR1_FEET.get()).m_79707_(2)).m_79076_(LootItem.m_79579_((ItemLike)ModArmors.MR1_LEGS.get()).m_79707_(2));
   }
}
