...
public class GinHardReward {
   ...
   static {
      ITEMS = LootPool.m_79043_().name("mineminenomi:items").m_165133_(ConstantValue.m_165692_(1.0F)).m_79076_(EmptyLootItem.m_79533_().m_79707_(97).m_79711_(-5)).m_79076_(LootItem.m_79579_((ItemLike)ModWeapons.TONFA.get()).m_79707_(3));
   }
}
