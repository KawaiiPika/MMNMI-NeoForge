...
public class ObtainBountyTrigger extends SimpleCriterionTrigger<Instance> {
   private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("mineminenomi", "obtain_bounty");
   ...
   public Instance createInstance(JsonObject json, ContextAwarePredicate pred, DeserializationContext ctx) {
      MinMaxBounds.Ints bounty = Ints.m_55373_(json.get("bounty"));
      return new Instance(pred, bounty);
   }
   ...
   public static class Instance extends AbstractCriterionTriggerInstance {
      ...
      public Instance(ContextAwarePredicate entityPredicate, MinMaxBounds.Ints predicate) {
         super(ObtainBountyTrigger.ID, entityPredicate);
      ...
      public JsonObject m_7683_(SerializationContext ctx) {
         ...
         jsonobject.add("bounty", this.predicate.m_55328_());
         return jsonobject;
      }
   }
}
