...
public class PhoenixAssaultFlyAnimation extends Animation<LivingEntity, HumanoidModel<LivingEntity>> {
   ...
   public void angles(LivingEntity entity, HumanoidModel<LivingEntity> model, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      if (!entity.m_6047_()) {
         ...
         if (posXDiff >= 0.2 || posZDiff >= 0.2) {
            angles = (float)Math.toRadians(movementDot > (double)0.0F ? (double)45.0F : (double)-45.0F);
         }

         if (posXDiff >= 0.6 || posZDiff >= 0.6) {
            angles = (float)Math.toRadians(movementDot > (double)0.0F ? (double)60.0F : (double)-60.0F);
         }
         ...
         if (model instanceof PhoenixAssaultModel) {
            PhoenixAssaultModel model2 = (PhoenixAssaultModel)model;
            if (movementDot > (double)0.0F) {
               if (posXDiff >= 0.2 || posZDiff >= 0.2) {
                  model2.upperLeftTail.f_104203_ = model2.upperRightTail.f_104203_ = model2.lowerLeftTail.f_104203_ = model2.lowerRightTail.f_104203_ = -0.5F;
                  model2.f_102813_.f_104201_ = model.f_102814_.f_104201_ = 8.0F;
                  model2.f_102813_.f_104202_ = model.f_102814_.f_104202_ = 8.0F;
                  model2.f_102813_.f_104203_ = model.f_102814_.f_104203_ = angles + 0.4F;
               }

               if (posXDiff >= 0.6 || posZDiff >= 0.6) {
                  model2.upperLeftTail.f_104203_ = model2.upperRightTail.f_104203_ = model2.lowerLeftTail.f_104203_ = model2.lowerRightTail.f_104203_ = -0.8F;
                  model2.f_102813_.f_104201_ = model.f_102814_.f_104201_ = 5.6F;
                  model2.f_102813_.f_104202_ = model.f_102814_.f_104202_ = 10.0F;
                  model2.f_102813_.f_104203_ = model.f_102814_.f_104203_ = angles + 0.4F;
               }
