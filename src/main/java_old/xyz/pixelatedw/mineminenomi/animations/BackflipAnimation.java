...
public class BackflipAnimation extends Animation<LivingEntity, HumanoidModel<LivingEntity>> {
   public BackflipAnimation(AnimationId<BackflipAnimation> animId) {
      super(animId);
   ...
   public void postAngles(LivingEntity entity, HumanoidModel<LivingEntity> entityModel, PoseStack poseStack, MultiBufferSource buffer, int packedLight, float partialTicks, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float axisMax = (float)this.getAnimationInitialDuration() * 0.4F;
      float axisCompletion = Math.min((float)this.getTime(), axisMax) / axisMax;
      if (this.getAnimationCompletion() >= 0.4F) {
         axisMax = (float)this.getAnimationInitialDuration() * 0.6F;
      ...
      poseStack.m_85837_((double)0.0F, (double)0.5F * (double)axisEase, (double)0.0F);
      poseStack.m_252781_(Axis.f_252495_.m_252977_(360.0F * bodyEase));
      entityModel.f_102808_.f_104203_ = 0.0F;
      entityModel.f_102813_.f_104203_ = 0.25F - (float)Math.toRadians((double)(80.0F * limbEase));
      entityModel.f_102813_.f_104204_ = 0.0F;
      entityModel.f_102813_.f_104205_ = 0.0F;
      entityModel.f_102814_.f_104203_ = (float)Math.toRadians((double)(50.0F * limbEase));
      entityModel.f_102814_.f_104204_ = 0.0F;
      entityModel.f_102814_.f_104205_ = 0.0F;
      entityModel.f_102811_.f_104203_ = (float)Math.toRadians((double)(50.0F * limbEase));
      entityModel.f_102811_.f_104204_ = 0.0F;
      entityModel.f_102811_.f_104205_ = 0.0F;
      entityModel.f_102812_.f_104203_ = 0.25F - (float)Math.toRadians((double)(80.0F * limbEase));
      entityModel.f_102812_.f_104204_ = 0.0F;
      entityModel.f_102812_.f_104205_ = 0.0F;
