...
public class ModI18nConfig {
   public static final String WORLD_RESTART_REQUIRED = "Requires a world restart in order to take effect!";
   ...
   public static final String TRAINING_POINT_LIMIT_TOOLTIP = "Sets a new limit for maximum training points a player may obtain\nDefault: 200";
   ...
   public static final String ALLOW_SUB_RACE_SELECT_TOOLTIP = "Allow players to choose their specific Sub Race, if that race has any \nDefault: true";
   ...
   public static final String CONFIG_TITLE;
   public static final String GENERAL_CATEGORY;
   public static final String ABILITIES_CATEGORY;
   public static final String STRUCTURES_CATEGORY;
   public static final String WORLD_EVENTS_CATEGORY;
   public static final String FACTION_CATEGORY;
   public static final String QUESTS_CATEGORY;
   public static final String CHALLENGES_CATEGORY;
   public static final String SYSTEM_CATEGORY;
   public static final String CLIENT_CATEGORY;
   public static final String UI_CATEGORY;
   public static final String KEEP_STATS_SUB_CATEGORY_TOOLTIP;
   public static final String BOUNTY_SUB_CATEGORY;
   public static final String CREW_SUB_CATEGORY;
   public static final String ORES_SUB_CATEGORY;
   public static final String TRADERS_SUB_CATEGORY;
   public static final String TRAINERS_SUB_CATEGORY;
   public static final String AMBUSHES_SUB_CATEGORY;
   public static final String SPAWN_CHANCES_SUB_CATEGORY;
   public static final String ONE_FRUIT_CATEGORY;
   public static final String HAKI_CATEGORY;
   public static final String DF_RESPAWNS_CATEGORY;
   public static final String ABL_PROTECTION_CATEGORY;
   public static final String NPCS_CATEGORY;

   public static void init() {
   }

   static {
      CONFIG_TITLE = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.title", "Mine Mine no Mi Config");
      GENERAL_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.general", "General");
      ABILITIES_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.devil_fruits", "Devil Fruits & Abilities");
      STRUCTURES_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.structures", "World Features");
      WORLD_EVENTS_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.world_events", "World Events");
      FACTION_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.factions", "Factions");
      QUESTS_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.quests", "Quests");
      CHALLENGES_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.challenges", "Challenges");
      SYSTEM_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.system", "System");
      CLIENT_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.client", "Client");
      UI_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.ui", "UI");
      KEEP_STATS_SUB_CATEGORY_TOOLTIP = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.keepstats.tooltip", "Please note that these settings only work if the \"Keep stats after Death\" option is set to CUSTOM!");
      BOUNTY_SUB_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.bounty", "Bounty");
      CREW_SUB_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.crew", "Crew");
      ORES_SUB_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.ores", "Ores");
      TRADERS_SUB_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.traders", "Traders");
      TRAINERS_SUB_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.trainers", "Trainers");
      AMBUSHES_SUB_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.ambushes", "Ambushes");
      SPAWN_CHANCES_SUB_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.spawn_chances", "Spawn Chances");
      ONE_FRUIT_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.onefruit", "One Fruit per World");
      HAKI_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.haki", "Haki");
      DF_RESPAWNS_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.dfrespawn", "Devil Fruit Reincarnation");
      ABL_PROTECTION_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.ablprotection", "Ability Protection");
      NPCS_CATEGORY = ModRegistry.registerName(ModRegistry.I18nCategory.GUI, "config.category.npcs", "NPCs");
   }
}
