   ...
   public void m_7892_(BlockState state, Level worldIn, BlockPos pos, Entity entity) {
      if (entity instanceof LivingEntity living) {
         if (!this.canWalkOn(living)) {
            entity.m_7601_(state, new Vec3(this.getHorizontalFallSpeed(), this.getVerticalFallSpeed(), this.getHorizontalFallSpeed()));
         }
      } else if (entity instanceof Boat boat) {
         boat.m_6074_();
      } else {
         entity.m_7601_(state, new Vec3(this.getVerticalFallSpeed(), this.getHorizontalFallSpeed(), this.getVerticalFallSpeed()));
      }
