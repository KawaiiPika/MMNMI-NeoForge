...
public class WrestlingDugongEntity extends AbstractDugongEntity {
   public WrestlingDugongEntity(EntityType<? extends WrestlingDugongEntity> type, Level world) {
      super(type, world);
      if (world != null && !world.f_46443_) {
         ...
         goals.addEntry((Supplier)() -> new GrabAbilityWrapperGoal(this, (AbilityCore)SpinningBrawlAbility.INSTANCE.get()), 1);
         ...
         this.f_21346_.m_25352_(2, new NearestAttackableTargetGoal(this, BoxingDugongEntity.class, true, false));
      }
   ...
   public AgeableMob m_142606_(ServerLevel world, AgeableMob mate) {
      WrestlingDugongEntity offspring = new WrestlingDugongEntity((EntityType)ModMobs.WRESTLING_DUGONG.get(), world);
   ...
   protected void setOffspringAttributes(AgeableMob mate, WrestlingDugongEntity offspring) {
