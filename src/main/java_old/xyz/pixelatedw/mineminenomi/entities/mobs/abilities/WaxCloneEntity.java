...
public class WaxCloneEntity extends CloneEntity {
   public WaxCloneEntity(EntityType<? extends WaxCloneEntity> type, Level world) {
      super(type, world);
   }

   public WaxCloneEntity(Level world, LivingEntity owner) {
      super((EntityType)ModMobs.WAX_CLONE.get(), world, owner);
   }

   public static AttributeSupplier.Builder createAttributes() {
      return OPEntity.createAttributes().m_22268_(Attributes.f_22277_, (double)35.0F).m_22268_(Attributes.f_22279_, (double)0.25F).m_22268_(Attributes.f_22276_, (double)10.0F).m_22268_(Attributes.f_22278_, (double)10.0F).m_22268_(Attributes.f_22284_, (double)2.0F);
   }
