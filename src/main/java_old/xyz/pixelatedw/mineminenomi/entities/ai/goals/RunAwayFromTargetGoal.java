...
public class RunAwayFromTargetGoal<E extends PathfinderMob> extends TickedGoal<E> {
   ...
   public RunAwayFromTargetGoal<E> setRunningDistance(int min, int max) {
   ...
   public boolean m_8036_() {
      if (this.restTicks > 0) {
         ...
         return !GoalHelper.isOutsideDistance(this.entity, this.target, (double)20.0F);
      }
   }
