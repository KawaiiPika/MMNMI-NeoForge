...
public class PackOfSharksProjectile extends NuProjectileEntity {
   public PackOfSharksProjectile(EntityType<? extends PackOfSharksProjectile> type, Level world) {
      super(type, world);
   }

   public PackOfSharksProjectile(Level world, LivingEntity player, IAbility ability) {
      super((EntityType)ModProjectiles.PACK_OF_SHARKS.get(), world, player, ability);
   ...
   private void blockHitEvent(BlockHitResult hit) {
      ExplosionComponent.createExplosion((IAbility)((IAbility)this.getParent().orElse((Object)null)), (comp) -> {
         AbilityExplosion explosion = comp.createExplosion(this, this.getOwner(), (double)hit.m_82425_().m_123341_(), (double)hit.m_82425_().m_123342_(), (double)hit.m_82425_().m_123343_(), 2.0F);
