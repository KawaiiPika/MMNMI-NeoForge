...
public class GomuGomuNoKingKongGunProjectile extends NuHorizontalLightningEntity {
   public GomuGomuNoKingKongGunProjectile(EntityType<? extends GomuGomuNoKingKongGunProjectile> type, Level world) {
      super(type, world);
   }

   public GomuGomuNoKingKongGunProjectile(Level world, LivingEntity entity, Ability ability) {
      super((EntityType)ModProjectiles.GOMU_GOMU_NO_KING_KONG_GUN.get(), entity, 80.0F, 10.0F, ability);
      this.setRetracting();
      this.setSize(0.05F);
      this.setOneTimeHit();
      this.setDepth(1);
