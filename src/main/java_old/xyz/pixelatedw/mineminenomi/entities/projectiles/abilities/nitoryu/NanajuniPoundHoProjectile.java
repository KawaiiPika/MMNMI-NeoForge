...
public class NanajuniPoundHoProjectile extends NuProjectileEntity {
   public NanajuniPoundHoProjectile(EntityType type, Level world) {
      super(type, world);
   }

   public NanajuniPoundHoProjectile(Level world, LivingEntity player, Ability ability) {
      super((EntityType)ModProjectiles.NANAJUNI_POUND_HO.get(), world, player, ability);
